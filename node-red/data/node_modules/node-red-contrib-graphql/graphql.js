module.exports = function(RED) {
  ...
  function GraphqlExecNode(config) {
    ...
    node.on("input", async function(msg, send, done) {
      ...
      const customHeaders = { ...node.customHeaders, ...msg.customHeaders } || {};
      var query;
      ...
      const variables = msg[node.varsField] || {}

      const url = node.graphqlConfig.endpoint;
      await axios({
        method: "POST",
        url,
        customHeaders,
        ...
        .then(function(response) {
          ...
          switch (true) {
            ...
            default:
              ...
              send([null, { ...msg, payload: response.data }]);
              done();
              break;
          }
        })
